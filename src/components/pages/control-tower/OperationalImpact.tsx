...
export const OperationalImpact = () => {
    return (
        <section className={`w-full bg-[#0B0616] py-6 md:py-6 lg:py-6 flex flex-col items-center px-4 md:px-6 lg:px-24 relative overflow-hidden ${montserrat.className}`}>
