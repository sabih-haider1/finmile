...
export const DspsFleetVisibility = () => {
    return (
        <section className={`w-full bg-[#FAFAFF] py-6 flex justify-center px-6 overflow-hidden ${montserrat.className}`}>
            <div className="w-full max-w-[1440px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative w-full flex items-center justify-center h-[350px] md:h-[450px] lg:h-[500px] order-1 lg:order-2">
