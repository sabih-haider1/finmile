    ...
    >
      <div className='max-w-[1400px] w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-12 items-start'>
        ...
        >
          ...
          <div className='relative z-0 w-full max-w-[800px]'>
            ...
            {/* 42% Card - Top Left */}
            <motion.div 
              className='absolute -top-4 left-0 md:-top-0 md:-left-24 z-40 bg-white/95 backdrop-blur-md rounded-[24px] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-white w-[220px] md:w-[320px] transform-gpu will-change-transform'
            ...
            <motion.div 
              className='absolute bottom-0 right-0 md:bottom-0 md:right-[-8px] z-10 bg-[#2D1B69] rounded-[24px] p-6 w-[200px] md:w-[300px] transform-gpu will-change-transform'
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
