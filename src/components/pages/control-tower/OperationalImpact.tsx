...
export const OperationalImpact = () => {
    return (
        <section className={`w-full bg-[#0B0616] py-[clamp(24px,4vw,32px)] flex flex-col items-center px-4 md:px-6 lg:px-24 relative overflow-hidden ${montserrat.className}`}>
            ...
            <div className="w-full max-w-[1240px] z-10 flex flex-col items-center text-center mb-10 md:mb-14">
                <h2 className="font-semibold text-white tracking-normal md:tracking-tight leading-[1.2] text-balance text-[clamp(32px,4vw,48px)]">
                    Operational Impact
                </h2>
            </div>
