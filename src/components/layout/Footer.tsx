...
export const Footer = () => {
    return (
        <footer className="w-full bg-[#1b0a4a] text-white pt-20 pb-12 px-6 lg:px-24 overflow-hidden relative">
            ...
            <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 z-10 relative">
                ...
                {/* Column 1: Brand & Actions (Wider column) */}
                <div className="flex flex-col space-y-10 md:col-span-4 lg:col-span-5">
                    {/* Brand Logo */}
                    <div className="mb-2">
                        <img src="/assets/logos/logo-white.png" alt="Finmile Logo" className="h-20 lg:h-28 w-auto object-contain drop-shadow-xl" />
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="mailto:hello@finmile.co" className="text-white text-[16px] xl:text-[18px] font-bold hover:text-[#D8C7FF] transition-colors tracking-wide">
                            hello@finmile.co
                        </a>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 mt-8">
                        <button className="bg-[#6A27D4] text-white px-10 py-5 rounded-full text-[16px] font-bold shadow-[0_10px_20px_rgba(106,39,212,0.4)] hover:bg-[#5a21b5] transition-all whitespace-nowrap">
                            Request A Demo
                        </button>
                        <button className="liquid-glass text-white px-10 py-5 rounded-full text-[16px] font-bold transition-all whitespace-nowrap">
                            Track Parcel
                        </button>
                    </div>
                </div>
                ...
                <div className="flex flex-col space-y-6 md:col-span-3 lg:col-span-2 mt-2 md:mt-0">
                ...
                <div className="flex flex-col space-y-6 md:col-span-3 lg:col-span-3 pt-0 md:pt-14">
                    <nav className="flex flex-col space-y-5 text-[#B8ADC9] text-[15px] font-medium">
                ...
                <div className="flex flex-col space-y-12 md:col-span-2 lg:col-span-2 mt-2 md:mt-0">
                    ...
                    {/* Get in Touch */}
                    <div className="flex flex-col space-y-6">
                        <h4 className="font-bold text-[18px] tracking-wide">Get In Touch</h4>
                        <nav className="flex flex-col space-y-5 text-[#B8ADC9] text-[15px] font-medium">
