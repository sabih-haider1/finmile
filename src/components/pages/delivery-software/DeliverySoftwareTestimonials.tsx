...
export const DeliverySoftwareTestimonials = () => {
    ...
    return (
        <section className={`w-full bg-white flex flex-col items-center px-4 md:px-6 lg:px-12 py-[clamp(24px,4vw,32px)] overflow-hidden relative ${montserrat.className}`}>
