...
export const DeliverySoftwarePlatform = () => {
    return (
        <section id="platform" className={`w-full bg-[#0B0616] py-12 md:py-16 lg:py-20 flex flex-col items-center px-6 lg:px-24 relative overflow-hidden ${montserrat.className}`}>
            ...
            <div className="max-w-[1440px] w-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-20 items-center z-10">
