    ...
    return (
        <section className={`w-full bg-white flex flex-col items-center px-4 md:px-6 lg:px-24 py-2 md:py-2 overflow-hidden relative ${montserrat.className}`}>
            <div className="text-center w-full z-10 flex flex-col items-center max-w-[1000px] mx-auto mb-10 md:mb-8">
                <h2 className="font-semibold text-[#2F1C8C] tracking-normal md:tracking-tight leading-[1.3] text-balance text-[clamp(32px,4vw,48px)]">
            ...
            <Link href="/integrations" className="bg-[#6A27D4] text-white px-5 md:px-8 md:px-10 py-3.5 md:py-4 rounded-full font-semibold text-[14px] md:text-[15px] shadow-[0_10px_20px_rgba(106,39,212,0.2)] transition-transform hover:scale-105 hover:bg-[#5821B0] z-10 text-center">
