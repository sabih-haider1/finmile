...
export const DriverAppAiTracking = () => {
    return (
        <section className={`w-full bg-[#fcfcff] flex flex-col items-center px-4 md:px-6 lg:px-24 py-6 lg:py-6 overflow-hidden relative border-y border-[#F0EDFF] ${montserrat.className}`}>
