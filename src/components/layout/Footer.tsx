...
export const Footer = () => {
    return (
        <footer className="w-full bg-[#0B0616] text-white pt-12 pb-4 px-3 sm:px-6 lg:px-16 overflow-hidden relative pointer-events-auto" style={{ isolation: 'isolate' }}>
            ...
            <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 lg:gap-8 z-20 relative items-start">

                {/* Column 1: Brand & Actions */}
                <div className="flex flex-col items-start space-y-4 md:space-y-10 md:col-span-6 lg:col-span-4 w-full">
                    {/* Brand Logo */}
                    <div className="mb-0 md:mb-2 relative left-[-24px] md:left-0">
                        <Link href="/">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="mailto:hello@finmile.co" className="text-white text-sm sm:text-[14px] lg:text-[16px] font-medium hover:text-[#D8C7FF] transition-colors tracking-wide break-all">
                            hello@finmile.co
                        </a>
                    </div>
                ...
                <div className="flex flex-col items-start space-y-6 md:col-span-2 lg:col-span-3 w-full text-left">
                    <h4 className="font-bold text-base sm:text-[18px] tracking-wide mb-0 md:mb-2">Quick Links</h4>
                    <nav className="flex flex-col items-start space-y-3 sm:space-y-5 text-[#B8ADC9] text-sm sm:text-[15px] font-medium w-full md:max-h-[220px] md:overflow-y-auto md:pr-2 md:pr-5 custom-scrollbar">
                ...
                {/* Column 3: Resources */}
                <div className="flex flex-col items-start space-y-6 md:col-span-2 lg:col-span-3 w-full text-left">
                    <h4 className="font-bold text-base sm:text-[18px] tracking-wide mb-0 md:mb-2">Resources</h4>
                    <nav className="flex flex-col items-start space-y-3 sm:space-y-5 text-[#B8ADC9] text-sm sm:text-[15px] font-medium w-full">
                ...
                <div className="flex flex-col items-start space-y-6 md:col-span-2 lg:col-span-2 w-full text-left">
                    <h4 className="font-bold text-base sm:text-[18px] tracking-wide mb-0 md:mb-2">Get In Touch</h4>
                    <nav className="flex flex-col items-start space-y-3 sm:space-y-5 text-[#B8ADC9] text-sm sm:text-[15px] font-medium w-full">
            ...
            {/* Bottom Legal Bar */}
            <div className="max-w-[1440px] mx-auto mt-8 pt-8 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between text-[#B8ADC9] text-xs sm:text-[13px] font-medium z-20 relative text-left md:text-left">
