...
export const OutcomesAtScale = () => {
    return (
        <section className={`w-full bg-[#fcfcff] flex flex-col items-center px-4 md:px-6 lg:px-24 py-16 md:py-16 lg:py-16 overflow-hidden relative ${montserrat.className}`}>
